...
function MyForm({onNextPage}) {
  ...
  <div className="class-form">
    ...
    <Row className="g-2 mb-3 ml-3">
      <Col md>
        <FloatingLabel controlId="floatingInput" label="Enter One of Your Skills" className="mb-3">
          <Form.Control type="text" name="skill7" value={formInput.skill7} onChange={handleChange} placeholder="skill 7" />
        </FloatingLabel>
      </Col>
      <Col md>
        <FloatingLabel controlId="floatingInput" label="Enter One of Your Skills" className="mb-3">
          <Form.Control type="text" name="skill8" value={formInput.skill8} onChange={handleChange} placeholder="skill 8" />
        </FloatingLabel>
      </Col>
    </Row>          
    ...
    <h3>First Professional Skill</h3>
    <FloatingLabel controlId="floatingInput" label="Add a Professional Skill" className="mb-3">
        <Form.Control type="text" name="prof1" value={formInput.prof1} onChange={handleChange} placeholder="prof1" />
    </FloatingLabel> 

    <h4>Skill Description in Points</h4>
    ...
    <h3>Second Professional Skill</h3>
    <FloatingLabel controlId="floatingInput" label="Add a Professional Skill" className="mb-3">
        <Form.Control type="text" name="prof2" value={formInput.prof2} onChange={handleChange} placeholder="prof2" />
    </FloatingLabel> 
    ...
    <h3>Third Professional Skill</h3>
    <FloatingLabel controlId="floatingInput" label="Add a Professional Skill" className="mb-3">
        <Form.Control type="text" name="prof3" value={formInput.prof3} onChange={handleChange} placeholder="prof3" />
    </FloatingLabel> 
    ...
    <FloatingLabel controlId="floatingInput" label="Company" className="mb-3">
        <Form.Control type="text" name="company1" value={formInput.company1} onChange={handleChange} placeholder="company1" />
    </FloatingLabel>
    ...
    <FloatingLabel controlId="floatingInput" label="Company" className="mb-3">
        <Form.Control type="text" name="company2" value={formInput.company2} onChange={handleChange} placeholder="company2" />
    </FloatingLabel>
    ...
    <FloatingLabel controlId="floatingInput" label="Company" className="mb-3">
        <Form.Control type="text" name="company3" value={formInput.company3} onChange={handleChange} placeholder="company3" />
    </FloatingLabel>
